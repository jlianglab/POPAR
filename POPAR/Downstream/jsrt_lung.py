...
parser.add_argument('--dataset', dest='dataset', default="jsrt_lung", type=str)
...
def main(conf):
    train_dataset = JSRTLungDataset(conf.train_image_path_file, image_size=(conf.img_size, conf.img_size))
    ...
    val_dataset = JSRTLungDataset(conf.val_image_path_file, image_size=(conf.img_size, conf.img_size), mode="val")
    ...
    test_dataset = JSRTLungDataset(conf.test_image_path_file, image_size=(conf.img_size, conf.img_size), mode="val")
