...
parser.add_argument('--dataset', dest='dataset', default="jsrt_heart", type=str)
...
def main(conf):
    train_dataset = JSRTHeartDataset(conf.train_image_path_file, image_size=(conf.img_size, conf.img_size))
    ...
    val_dataset = JSRTHeartDataset(conf.val_image_path_file, image_size=(conf.img_size, conf.img_size), mode="val")
    ...
    test_dataset = JSRTHeartDataset(conf.test_image_path_file, image_size=(conf.img_size, conf.img_size), mode="val")
