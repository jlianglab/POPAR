...
parser.add_argument('--run', dest='run', default="nih14_full_tuning", type=str)
...
parser.add_argument('--optm', dest='optm', default="adamw", type=str, help="Optimizer")
...
def main(conf):
    ...
    train_dataset = build_classfication_dataset("ChestXray14", conf.train_image_path_file, conf.input_size, conf.anno_percent, mode="train")
    valid_dataset = build_classfication_dataset("ChestXray14", conf.valid_image_path_file, conf.input_size, anno_percent = 100, mode="validation")
    test_dataset = build_classfication_dataset("ChestXray14", conf.test_image_path_file, conf.input_size, anno_percent = 100, mode="test")
    test_dataset_noTenC = build_classfication_dataset("ChestXray14", conf.test_image_path_file, conf.input_size, anno_percent = 100, mode="validation")
